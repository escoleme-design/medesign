    ...
    filled: {
        ...
        layout: {
            ...
            large: {
                ...
                iconSize: 20,
                leftRightPadding: 28,
                LeftPaddingWithIcon: 18,
                rightPaddingWithIcon: 28,
    ...
    text: {
        ...
        layout: {
            small: {
                ...
                containerWidth: 40,
                leftRightPadding: 10,
                LeftPaddingWithIcon: 10,
                rightPaddingWithIcon: 14,
                paddingBetweenElements: 6,
                labelTextAlignment: 'center',
                labelText: {
                    font: typescale.labelLarge.font,
